def StellarVoyager():
    """Cette fonction lance notre programme. Pour cela, elle importe toutes les fonctions nécessaires et les exécutent dans le bon ordre.
    """
    ...
    # Commence les calculs pour la mission
